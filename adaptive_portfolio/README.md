...
> Программный артефакт курсовой работы НГУ, 3 курс, Бизнес-информатика, 2026.
...
- 📊 Walk-forward бэктест с шестью бенчмарками: `IMOEX`, `EW`, `Static MVO`, `Risk
  Parity`, `Min Variance`, `Max Sharpe`. 13 метрик, t-тест α, блочный бутстрап Шарпа,
...
```bash
git clone <ваш-репозиторий>.git adaptive_portfolio
